...
export const firstDayFlags={street:'FIRST_DAY_ENTERED_BAISHI',trade:'FIRST_DAY_FIRST_TRADE_COMPLETED',returned:'FIRST_DAY_RETURNED_TO_INN',complete:'FIRST_DAY_COMPLETE'} as const;
...
export const firstDayNpcIntroductions:Record<string,string>={
  NPC_001:'在这儿住得惯就好。街上不大，慢慢走走，总会找到自己的路。',
