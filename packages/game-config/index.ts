...
export const initialWorld: WorldConfig = {
  ...
  items:[{id:'RICE_01',name:'鸣山大米',icon:'米',basePrice:12,giftable:true,stackMax:99},{id:'SNACK_01',name:'横阳米糕',icon:'糕',basePrice:8,giftable:true,stackMax:99}],
