...
export const initialWorld: WorldConfig = {
  ...
  plots:baishiPlots,
  npcs:[{id:'NPC_001',name:'陈掌柜',nameLocked:true,enabled:true,sceneId:'INTERIOR_B_INN',x:8,y:9,priority:100,hours:['00:00','00:00'],questId:'Q_002',dialogue:['急件拿到了就好，辛苦你跑这一趟。','白石街不大，慢慢走走，总会找到自己的路。'],route:[{x:8,y:9},{x:10,y:9}],appearance:{gender:'MALE',baseAvatarId:'MALE_05',hairStyleId:'HAIR_MALE_06',hairColorId:'CHESTNUT',topStyleId:'TOP_MALE_04',topColorId:'BLUE',bottomStyleId:'BOTTOM_MALE_02',bottomColorId:'CREAM',shoesId:'SHOES_MALE_02',accessoryIds:[]}},    {id:'NPC_TRADE_CLERK',name:'白石商行伙计',nameLocked:false,enabled:true,sceneId:'INTERIOR_B_TRADE',x:12,y:9,priority:80,hours:['00:00','00:00'] as [string,string],questId:'Q_001',dialogue:['想试试做点小买卖？街坊杂货铺有鸣山大米。你买一份来，我按收价给你算。','大米买好后带来柜台，我替你过秤收下。'],route:[],appearance:{gender:'MALE',baseAvatarId:'MALE_02',hairStyleId:'HAIR_MALE_04',hairColorId:'INK',topStyleId:'TOP_MALE_02',topColorId:'SAGE',bottomStyleId:'BOTTOM_MALE_01',bottomColorId:'CREAM',shoesId:'SHOES_MALE_01',accessoryIds:[]}},
    ...
    {id:'NPC_CLOTH_SHOPKEEPER',name:'春衫掌柜',nameLocked:false,enabled:true,sceneId:'INTERIOR_B_CLOTH',x:16,y:9,priority:75,hours:['00:00','00:00'] as [string,string],facing:'down',questId:'Q_003',dialogue:['欢迎来到春衫衣坊。衣裳不只是遮风挡雨，也能穿出一个人的精神。','以后想添件新衣、换换装束，都可以来找我。'],route:[],formalArtKey:'npc_cloth_shopkeeper_walk',portraitKey:'portrait_cloth_shopkeeper_normal',appearance:{gender:'MALE',baseAvatarId:'MALE_04',hairStyleId:'HAIR_MALE_03',hairColorId:'INK',topStyleId:'TOP_MALE_03',topColorId:'SAGE',bottomStyleId:'BOTTOM_MALE_02',bottomColorId:'CREAM',shoesId:'SHOES_MALE_02',accessoryIds:[]}},
    ...[
