...
export const initialWorld: WorldConfig = {
  ...
  items:[{id:'RICE_01',name:'鸣山大米',icon:'米',basePrice:12,giftable:true,stackMax:99},{id:'SNACK_01',name:'横阳米糕',icon:'糕',basePrice:8,giftable:true,stackMax:99},{id:'ERRAND_PACKAGE_01',name:'掌柜的急件',icon:'件',basePrice:1,giftable:false,stackMax:1,questOnly:true},{id:'CLOTH_SAMPLE_01',name:'新布样',icon:'布',basePrice:1,giftable:false,stackMax:1,questOnly:true}],
