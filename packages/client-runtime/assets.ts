...
export const baishiInteriorArtRegistry: InteriorArtAsset[] = [
  { sceneId: 'INTERIOR_B_SALON', assetKey: 'interior-salon-bg-v1', resourceId: 'BAISHI_INTERIOR_SALON_BG', fallbackPath: '/scene-layers/baishi/interiors/generic_interior_fallback.png', foreground: { assetKey: 'interior-salon-fg-v1', resourceId: 'BAISHI_INTERIOR_SALON_FG', fallbackPath: '/scene-layers/baishi/interiors/generic_interior_foreground.png', occlusionFrontY: 10.0 }, width: 768, height: 640 },
  { sceneId: 'INTERIOR_B_GROCERY', assetKey: 'interior-grocery-bg-v1', resourceId: 'BAISHI_INTERIOR_GROCERY_BG', fallbackPath: '/scene-layers/baishi/interiors/generic_interior_fallback.png', foreground: { assetKey: 'interior-grocery-fg-v1', resourceId: 'BAISHI_INTERIOR_GROCERY_FG', fallbackPath: '/scene-layers/baishi/interiors/generic_interior_foreground.png', occlusionFrontY: 10.0 }, width: 768, height: 640 },
  { sceneId: 'INTERIOR_B_TRADE', assetKey: 'interior-trade-bg-v1', resourceId: 'BAISHI_INTERIOR_TRADE_BG', fallbackPath: '/scene-layers/baishi/interiors/generic_interior_fallback.png', foreground: { assetKey: 'interior-trade-fg-v1', resourceId: 'BAISHI_INTERIOR_TRADE_FG', fallbackPath: '/scene-layers/baishi/interiors/generic_interior_foreground.png', occlusionFrontY: 10.0 }, width: 768, height: 640 },
  { sceneId: 'INTERIOR_B_CLOTH', assetKey: 'interior-cloth-bg-v1', resourceId: 'BAISHI_INTERIOR_CLOTH_BG', fallbackPath: '/scene-layers/baishi/interiors/generic_interior_fallback.png', foreground: { assetKey: 'interior-cloth-fg-v1', resourceId: 'BAISHI_INTERIOR_CLOTH_FG', fallbackPath: '/scene-layers/baishi/interiors/generic_interior_foreground.png', occlusionFrontY: 12.0 }, width: 768, height: 640 },
  { sceneId: 'INTERIOR_B_INN', assetKey: 'interior-inn-bg-v1', resourceId: 'BAISHI_INTERIOR_INN_BG', fallbackPath: '/scene-layers/baishi/interiors/generic_interior_fallback.png', foreground: { assetKey: 'interior-inn-fg-v1', resourceId: 'BAISHI_INTERIOR_INN_FG', fallbackPath: '/scene-layers/baishi/interiors/generic_interior_foreground.png', occlusionFrontY: 10.0 }, width: 768, height: 640 },
  { sceneId: 'INTERIOR_B_INN_GUEST_ROOM', assetKey: 'interior-guest-room-bg-v2', resourceId: 'BAISHI_INTERIOR_GUEST_ROOM_BG', fallbackPath: '/scene-layers/baishi/interiors/generic_interior_fallback.png', foreground: { assetKey: 'interior-guest-room-fg-v2', resourceId: 'BAISHI_INTERIOR_GUEST_ROOM_FG', fallbackPath: '/scene-layers/baishi/interiors/generic_interior_foreground.png', occlusionFrontY: 7.5 }, width: 448, height: 384 },
];
