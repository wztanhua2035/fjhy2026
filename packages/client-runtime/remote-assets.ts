...
export const remoteAssetManifest: RemoteAssetManifest = {
  manifestVersion: 1,
  resources: {
    BAISHI_INTERIOR_SALON_BG: interior('BAISHI_INTERIOR_SALON_BG', 'world/baishi/interiors/salon/background_v7.png', '/scene-layers/baishi/interiors/interior_salon_v1.png', 'scene-background', 7),
    ...
    BAISHI_INTERIOR_GROCERY_BG: interior('BAISHI_INTERIOR_GROCERY_BG', 'world/baishi/interiors/grocery/background_v4.png', '/scene-layers/baishi/interiors/interior_grocery_v1.png', 'scene-background', 4),
    ...
    BAISHI_INTERIOR_TRADE_BG: interior('BAISHI_INTERIOR_TRADE_BG', 'world/baishi/interiors/trade/background_v5.png', '/scene-layers/baishi/interiors/interior_trade_v1.png', 'scene-background', 5),
    ...
    BAISHI_INTERIOR_CLOTH_BG: interior('BAISHI_INTERIOR_CLOTH_BG', 'world/baishi/interiors/cloth/background_v7.png', '/scene-layers/baishi/interiors/interior_cloth_v1.png', 'scene-background', 7),
    BAISHI_INTERIOR_CLOTH_FG: interior('BAISHI_INTERIOR_CLOTH_FG', 'world/baishi/interiors/cloth/foreground_v2.png', '/scene-layers/baishi/interiors/interior_cloth_fg_v1.png', 'scene-foreground', 2),
    BAISHI_INTERIOR_INN_BG: interior('BAISHI_INTERIOR_INN_BG', 'world/baishi/interiors/inn/background_v3.png', '/scene-layers/baishi/interiors/interior_inn_v1.png', 'scene-background', 3),
    ...
    BAISHI_INTERIOR_GUEST_ROOM_BG: interior('BAISHI_INTERIOR_GUEST_ROOM_BG', 'world/baishi/interiors/guest-room/background_v4.png', '/scene-layers/baishi/interiors/interior_guest_room_v2.png', 'scene-background', 4),
