...
test('微信正文、说话人、按钮和任务字级增大，安全区仍有换行宽度',()=>{
  assert.deepEqual(mobileTypography,{dialogue:21,speaker:23,option:23,quest:17});
