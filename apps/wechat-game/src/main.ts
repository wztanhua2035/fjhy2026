...
class BaishiWechatScene extends Phaser.Scene {
  ...
  private syncUi() {
    ...
    const canShop = !dialogue && !!controller.shopPanel() && controller.canUseNpcServices();
