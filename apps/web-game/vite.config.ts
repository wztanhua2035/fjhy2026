...
export default defineConfig({
  ...
  server: { host: '0.0.0.0', proxy: { '/v1': 'http://localhost:8080', '/healthz': 'http://localhost:8080', '/__fjhy_cdn__': { target: remoteAssetOrigin, changeOrigin: true, rewrite: path => path.replace(/^\/__fjhy_cdn__/, '') } } },
