...
for(const [account,sceneId] of rooms){
  ...
  Object.assign(player,{sceneId,...point,storyFlags:{INTRO_INN_KEEPER_DONE:true,GUEST_ROOM_LIFE_UNLOCKED:true,FIRST_DAY_WAKE_DONE:true,FIRST_DAY_ENTERED_BAISHI:true},inventory:{RICE_01:2}});
